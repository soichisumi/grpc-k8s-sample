module github.com/soichisumi/grpc-k8s-sample
...
require (
	...
	github.com/soichisumi/grpc-k8s-sample/api v0.0.0-20190226122653-d4f35df95430 // indirect
	github.com/soichisumi/grpc-k8s-sample/gw v0.0.0-20190226122653-d4f35df95430 // indirect
